...
**⚙️ Two-Pass Assembler**  ·  [Code](https://github.com/MohabAbdelatief/Two-Pass-Assembler)
Translates assembly into machine code — symbol-table generation + label resolution.
`Swift`
